...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("li", null, 
	        React.createElement("a", {href: this.props.repo.html_url}, this.props.repo.name), " [", repo_score, "]", 
	...
	ReactDOM.render(React.createElement(RepoList, {user: USER}), document.getElementById("main"));
	ReactDOM.render(React.createElement(Profile, {user: USER}), document.getElementById("top-body"));
